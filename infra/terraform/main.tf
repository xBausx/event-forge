...
# Execution policy (merged; single source of truth)
data "aws_iam_policy_document" "lambda_exec_policy" {
    ...
    statement {
        ...
        aws_secretsmanager_secret.inngest_signing_key.arn
        ]
    }

    # Allow orchestration Lambda to invoke app Lambdas (no cycle: wildcard by prefix)
    statement {
